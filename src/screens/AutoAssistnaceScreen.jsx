    ...
    <SafeAreaView style={styles.container} edges={["bottom"]}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.headerSubtitle}>
          Изберете параметри за вашата застраховка
        </Text>
        ...
        <View style={styles.ageToggleContainer}>
          {assistanceData.map((group) => (
            <TouchableOpacity
              ...
              style={[
                styles.ageButton,
                selectedAgeGroup?.age_label === group.age_label &&
                  styles.activeAgeButton,
              ]}
              onPress={() => {
            ...
            >
              <View style={styles.periodInfo}>
                ...
                <View style={styles.priceColumn}>
                  <Text style={styles.bgnPrice}>
                    {period.bgn.toFixed(2)} лв.
                  </Text>
          ...
          <View style={styles.summaryCard}>
            <View style={styles.summaryRow}>
              ...
              <Text style={styles.summaryTotal}>
                {selectedPeriod.bgn.toFixed(2)} лв.
              </Text>
            </View>
